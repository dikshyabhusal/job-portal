...
<div class="max-w-7xl mx-auto px-6 py-12">
    <h2 class="text-2xl font-bold mb-6 text-blue-700">Search Results for: "{{ $query }}"</h2>
    ...
    @else
        <p class="text-gray-500 mt-8 text-lg text-center">No jobs found for your search.</p>
    @endif
</div>
@endsection
